        ...
        <main className='container __my-container' justify='space-evenly'>
            <section justify='space-evenly' className='my-section'>
                ...
                <div className='my-desc-button'>
                    <a className='my-resume __my-button-desc' href="https://drive.google.com/file/d/1EDWv9YcTooTXSmkn03ByIK0ONMgQKJys/view?usp=sharing" target="_blank" aria-label='Email' rel="noopener noreferrer" style={{color: darkMode ? '#e2e8f0' : '#000'}}>
                        My Resume
